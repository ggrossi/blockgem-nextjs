      ...
      <div className="max-w-6xl px-4 py-8 mx-auto sm:py-24 sm:px-6 lg:px-8">
        ...
        <div className="sm:flex sm:flex-col sm:align-center">
          ...
          <Link
            ...
            className="max-w-2xl m-auto mt-4 mb-8 text-xl px-4 py-2 font-bold text-lighten bg-pink-500 rounded-lg hover:bg-pink-700 focus:outline-none focus:shadow-outline"
          >
